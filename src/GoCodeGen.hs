...
\\t\t}\n\
\\t\tstack_ptr += 1\n\
\\t\tstack[stack_ptr + scope_ptr] = core.MakeInt("++ show returnAddr ++ ")\n\
\\t\tstack[stack_ptr + scope_ptr + 1] = core.MakeInt(scope_ptr)\n\
...
\\n\
\\tvar jump_addr int = 0\n\
\\tvar stack []core.Wrapped = make([]core.Wrapped, 1000)\n\
\\tvar scope_ptr int = -1\n\
\\tvar stack_ptr int = 0\n\
\\tvar reg core.Wrapped\n\
\\n\
\JUMP:\n\
\\n\
\\tswitch jump_addr {\n"
